...
export default function CreateListingPage() {
  ...
  useEffect(() => {
    const fetchPromotionPackages = async () => {
      try {
        const res = await fetch('/api/promotion-packages?type=LISTING');
        if (res.ok) {
            ...
            <div className="rounded-xl border border-slate-700 bg-slate-800 p-6">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                {promotionPackages.map((pkg) => (
                  <button
                    ...
                    style={{
                      borderColor:
                        formData.promotionPackage === pkg.id ? pkg.badgeColor : undefined,
                      backgroundColor:
                  ...
                  >
                    ...
                    >
                      <StarIcon className="h-5 w-5" style={{ color: pkg.badgeColor }} />
                    </div>
              ...
              {(() => {
                const selectedPkg = promotionPackages.find(
                  (p) => p.id === formData.promotionPackage,
                );
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        >
                          <StarIcon className="h-5 w-5" style={{ color: selectedPkg.badgeColor }} />
                        </div>
                        <div>
