            ...
            {promotionPackages.map((pkg) => (
              ...
              >
                ...
                <div className="mb-3 text-center">
                  ...
                  >
                    <StarIcon className="h-5 w-5" style={{ color: pkg.badgeColor || '#94a3b8' }} />
                  </div>
                  <h3 className="font-bold text-white">{pkg.nameAr}</h3>
                  <div
                  ...
                  {pkg.duration > 0 && (
                    <div className="text-xs text-slate-400">{pkg.duration} يوم</div>
                  )}
                </div>
