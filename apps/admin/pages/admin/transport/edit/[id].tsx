                ...
                {promotionPackages.map((pkg) => (
                  <div
                    ...
                    onClick={() =>
                      setFormData({
                        ...
                        promotionDays: pkg.duration,
                        featured: pkg.price > 0,
                      })
                    }
                  ...
                  >
                    {pkg.price > 20 && pkg.price < 60 && (
                      <span
                        className="absolute -top-2 left-1/2 -translate-x-1/2 rounded-full px-2 py-0.5 text-xs font-bold text-white"
                    ...
                    <div className="text-center">
                      <h4 className="mb-1 font-bold text-white">{pkg.nameAr}</h4>
                      <p
                        className="text-2xl font-bold"
                        style={{ color: pkg.badgeColor || '#60a5fa' }}
                      >
                        {pkg.price === 0 ? 'مجاني' : `${pkg.price} د.ل`}
                      </p>
                      {pkg.duration > 0 && (
                        <p className="text-sm text-slate-400">{pkg.duration} يوم</p>
                      )}
                        ...
                        {pkg.features &&
                          ...
                          pkg.features.map((feature: string, idx: number) => (
                            <li key={idx} className="flex items-center gap-1">
                              <CheckCircleIcon
                                className="h-3 w-3"
                                style={{ color: pkg.badgeColor || '#4ade80' }}
                              />
                              <span>{feature}</span>
                            </li>
                          ))}
