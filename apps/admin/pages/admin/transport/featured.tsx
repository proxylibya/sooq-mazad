...
export default function FeaturedTransportPage() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const revenue = featuredServices.reduce((sum: number, s: FeaturedService) => {
          const pkg = promotionPackages.find((p) => p.id === s.promotionPackage);
  ...
  const getPackageInfo = (packageId: string) => {
    if (packageId === 'free') return { nameAr: 'مجاني', price: 0, badgeColor: '#64748b' };
    return (
      promotionPackages.find((p) => p.id === packageId) || {
        nameAr: 'غير معروف',
        price: 0,
        badgeColor: '#64748b',
      }
                    ...
                    <div>
                      ...
                      <div className="mt-2 flex items-center gap-2">
                        <span
                          ...
                          style={{
                            backgroundColor: `${pkgInfo.badgeColor}20`,
                            color: pkgInfo.badgeColor,
                            borderColor: `${pkgInfo.badgeColor}30`,
                          }}
                        >
