      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-amber-500/30 bg-gradient-to-r from-amber-500/5 to-yellow-500/5 p-6">
              ...
              {promotionPackages.map((pkg) => (
                ...
                >
                  ...
                  {pkg.price > 20 && pkg.price < 60 && (
                    <div className="absolute -top-2 right-4">
                      <span
                        ...
                        style={{ backgroundColor: pkg.badgeColor || '#eab308' }}
                      >
                        الأفضل
                      </span>
                    </div>
                  ...
                  <div
                    ...
                    style={{ backgroundColor: `${pkg.badgeColor || '#475569'}20` }}
                  >
                    <SparklesIcon
                      className="h-5 w-5"
                      style={{ color: pkg.badgeColor || '#94a3b8' }}
                    />
                  </div>
                  ...
                  <div className="mt-1 flex items-center justify-between">
                    ...
                    <span
                      ...
                      style={{ color: pkg.badgeColor || '#cbd5e1' }}
                    >
            ...
            {formData.promotionPackage !== 'free' && formData.promotionPackage !== 'NONE' && (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-white">
                      {promotionPackages.find((p) => p.id === formData.promotionPackage)?.nameAr ||
                        formData.promotionPackage}
                    </p>
                  </div>
                </div>
