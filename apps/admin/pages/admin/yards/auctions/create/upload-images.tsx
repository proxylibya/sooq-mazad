/**
 * صفحة رفع صور مزاد الساحة - لوحة التحكم
 * Upload Yard Auction Images - Admin Panel
 */
...
export default function UploadYardAuctionImagesPage() {
  ...
  const handleContinue = () => {
    ...
    if (savedData) {
      ...
      localStorage.setItem('adminYardAuctionData', JSON.stringify(data));
      ...
      localStorage.setItem('adminYardAuctionData', JSON.stringify(newData));
      console.log('[Upload] تم إنشاء بيانات جديدة');
    }

    router.push('/admin/yards/auctions/create/preview');
  };
  ...
  return (
    <AdminLayout title="رفع صور مزاد الساحة">
