                ...
                <div className="flex flex-wrap items-start gap-1 text-xs">
                  {(() => {
                    ...
                    if (car.mileage && typeof car.mileage === 'string' && car.mileage !== '0') {
                      // Check if 'كم' is already included to avoid duplication
                      const mileageText = car.mileage.includes('كم') 
                        ? car.mileage 
                        : `${car.mileage} كم`;
                      properties.push(mileageText);
                    }
                    if (
                      car.transmission &&
                    ...
                    <div className="flex items-start gap-1 text-gray-500">
                      ...
                      <span>
                        {(() => {
                          ...
                          if (diffMins < 60) {
                            return diffMins <= 1 ? 'الآن' : `منذ ${diffMins} دقيقة`;
