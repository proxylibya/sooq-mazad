...
interface FormData {
  ...
  promotionPackage: string; // باقة الترويج
                      ...
                      <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                        ...
                        <div className="rounded-xl border border-gray-200 bg-white p-3 shadow-sm">
                          <button
                            ...
                            className="flex w-full items-center justify-center gap-3 rounded-xl border-2 border-dashed border-blue-300 bg-blue-50 px-4 py-4 text-blue-600 transition-all duration-300 hover:border-blue-400 hover:bg-blue-100 hover:shadow-md active:scale-[0.98]"
                          >
                            <div className="flex items-center gap-3">
                              ...
                              <div className="text-right">
                                ...
                                <div className="text-xs opacity-80">
                                  {formData.coordinates
                                    ? formData.detailedAddress || 'تم تحديد الموقع'
          ...
          <div className="mt-10 rounded-3xl bg-gradient-to-b from-slate-50 to-white p-8">
            ...
            <div className="grid grid-cols-2 gap-6 lg:grid-cols-4">
              {promotionPackages.map((pkg) => (
                ...
                >
                  {formData.promotionPackage === pkg.id && (
                    <div
                      className="absolute -left-2 -top-2 flex h-8 w-8 items-center justify-center rounded-full shadow-lg"
                  ...
                  <div className="flex h-full flex-col items-center justify-center text-center">
                    ...
                    >
                      <SparklesIcon className="h-8 w-8" style={{ color: pkg.badgeColor }} />
                    </div>
                    <h4 className="mb-2 text-xl font-black text-slate-800">{pkg.nameAr}</h4>
                    <p className="text-3xl font-black" style={{ color: pkg.badgeColor }}>
                      {pkg.price}
                    </p>
                    <p className="text-sm font-semibold text-slate-500">
                      دينار / {pkg.duration} يوم
                    </p>
            ...
            {(() => {
              ...
              if (selectedPkg && selectedPkg.price > 0) {
                return (
                  <div
                    className="mt-8 flex items-center justify-between rounded-2xl border-2 bg-opacity-10 p-5"
                    style={{
                      borderColor: selectedPkg.badgeColor,
                      backgroundColor: `${selectedPkg.badgeColor}10`,
                    }}
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className="flex h-14 w-14 items-center justify-center rounded-xl"
                        style={{ backgroundColor: `${selectedPkg.badgeColor}30` }}
                      >
                        <SparklesIcon
                          className="h-7 w-7"
                      ...
                      <div>
                        <p className="text-xl font-black text-slate-900">{selectedPkg.nameAr}</p>
                        <p className="text-base font-medium text-slate-600">
                          ظهور مميز لمدة {selectedPkg.duration} يوم
                        </p>
                      </div>
                    </div>
                    <p className="text-4xl font-black" style={{ color: selectedPkg.badgeColor }}>
                      {selectedPkg.price}
