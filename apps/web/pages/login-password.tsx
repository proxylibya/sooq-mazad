              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="mb-6 mt-8 flex items-center justify-between">
                  ...
                  <label className="group flex cursor-pointer select-none items-center">
                    <span className="ml-3 text-sm font-medium leading-6 text-gray-700 transition-colors duration-200 group-hover:text-blue-600">
                      تذكرني
                    </span>
                    <div className="relative flex items-center justify-center">
                      ...
                      />
                      <div
                        className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-full border-2 transition-all duration-300 ease-in-out ${
                          rememberMe
                            ? 'border-blue-600 bg-white shadow-md ring-2 ring-blue-100'
                            : 'border-gray-300 bg-white group-hover:border-blue-400 group-hover:shadow-sm'
                        }`}
                      >
                        {/* النقطة الدائرية الداخلية */}
                        <div
