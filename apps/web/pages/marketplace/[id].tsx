  ...
  try {
    ...
    if (!car) {
      ...
      if (directCar) {
        ...
        const listing = {
          ...
          // بيانات البائع
          seller: {
            id: directCar.users?.id || directCar.sellerId || 'unknown',
          ...
          inspectionReport: {
            ...
            manualData: directCar.manualInspectionData
    ...
    const listing = {
      ...
      inspectionReport: {
        ...
        manualData: (car as any).manualInspectionData
