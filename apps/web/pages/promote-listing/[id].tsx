      ...
      try {
        ...
        if (res.ok) {
          ...
          const mappedPackages = data.data.map((pkg: any) => ({
            ...
            boost: pkg.description || 'ترويج مميز',
            ...
            popular: pkg.price >= 30 && pkg.price < 60,
          }));
          setPromotionPackages(mappedPackages);
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <div
                            className={`ml-4 rounded-lg p-3 ${!pkg.color.startsWith('#') ? `bg-gradient-to-r ${pkg.color}` : ''}`}
                            style={{
                              backgroundColor: pkg.color.startsWith('#') ? pkg.color : undefined,
                            }}
                          >
                            {pkg.icon}
