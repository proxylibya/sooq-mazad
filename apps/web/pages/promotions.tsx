        ...
        <div className="mx-auto max-w-6xl px-4 py-12">
          ...
          <div className="mb-12">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {packages.map((pkg) => {
                const isHex = pkg.badgeColor && pkg.badgeColor.startsWith('#');
                const borderColor = isHex ? pkg.badgeColor : 'gray';
                const bgColor = isHex ? `${pkg.badgeColor}10` : 'white'; // 10% opacity

                return (
                  <div
                    key={pkg.id}
                    className={`relative overflow-hidden rounded-3xl border-2 p-6 shadow-lg transition-all hover:shadow-xl`}
                    style={{
                  ...
                  >
                    {pkg.price > 20 && pkg.price < 60 && (
                      <div
                        className="absolute -left-10 top-6 rotate-[-45deg] px-12 py-1 text-xs font-bold text-white shadow"
                    ...
                    <div className="mb-4 flex items-center gap-3">
                      <div
                        ...
                        style={{ backgroundColor: pkg.badgeColor || '#6b7280' }}
                      >
                        {pkg.price >= 60 ? (
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{pkg.duration} يوم</p>
                      </div>
                    </div>
                    ...
                    <div className="rounded-xl bg-white/50 p-3 text-center">
                      ...
                      <div className="text-2xl font-black text-amber-600">
                        ×{pkg.price > 50 ? 6 : pkg.price > 20 ? 4 : 2}
                      </div>
                    </div>
                  </div>
                );
                            ...
                            <div className="flex items-center justify-between rounded-xl bg-green-100 p-3">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-bold text-green-700">
                                  باقة{' '}
                                  {packages.find((p) => p.id === listing.promotionPackage)
                                    ?.nameAr || listing.promotionPackage}
                                </span>
                              </div>
                            </div>
