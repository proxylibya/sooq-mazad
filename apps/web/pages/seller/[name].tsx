                      ...
                      <div className="flex gap-3">
                        ...
                        >
                          ...
                          {isContactLoading ? (
                            ...
                            <PhoneIcon className="h-5 w-5 transition-transform group-hover:scale-105" />
                          )}
                        ...
                        >
                          {isMessageLoading ? (
                            ...
                            <ChatBubbleLeftRightIcon className="h-5 w-5 transition-transform group-hover:scale-105" />
                          )}
                          <span className="relative z-10">
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          {isShareLoading ? (
                            ...
                            <ShareIcon className="h-5 w-5 text-blue-600 transition-all group-hover:scale-105" />
                          )}
                        </Button>
                        <Button
                          variant="outline"
                        ...
                        >
                          <HeartIcon className="h-5 w-5 text-red-500 transition-all group-hover:scale-105 group-hover:fill-current" />
                        </Button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="group rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 p-4 transition-all duration-300 hover:shadow-lg">
                      <div className="flex items-center justify-between">
                        ...
                        <EyeIcon className="h-8 w-8 text-purple-400 transition-transform group-hover:scale-105" />
                      </div>
                    </div>
                    ...
                    {sellerData.stats.soldListings > 0 && (
                      <div className="group rounded-xl bg-gradient-to-br from-amber-50 to-amber-100 p-4 transition-all duration-300 hover:shadow-lg">
                        <div className="flex items-center justify-between">
                          ...
                          <TrophyIcon className="h-8 w-8 text-amber-400 transition-transform group-hover:scale-105" />
                        </div>
                      </div>
                    )}
                    ...
                    {sellerData.stats.totalAuctions > 0 && (
                      <div className="group rounded-xl bg-gradient-to-br from-rose-50 to-rose-100 p-4 transition-all duration-300 hover:shadow-lg">
                        <div className="flex items-center justify-between">
                          ...
                          <ChartBarIcon className="h-8 w-8 text-rose-400 transition-transform group-hover:scale-105" />
                        </div>
                      </div>
                    )}
                  </div>
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="group rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 p-4 transition-all duration-300 hover:shadow-lg">
                    <div className="flex items-center gap-3">
                      <ClockIcon className="h-6 w-6 text-blue-600 transition-transform group-hover:scale-105" />
                      <div className="flex-1">
              ...
              {sellerData.description && sellerData.description !== 'لا يوجد وصف' && (
                <Card className="group overflow-hidden border-0 shadow-lg transition-all duration-300 hover:shadow-xl">
                  <CardHeader className="bg-gradient-to-r from-indigo-50 to-purple-50 pb-4">
                    <div className="flex items-center gap-3">
                      <div className="rounded-xl bg-indigo-100 p-3 transition-transform group-hover:scale-105">
              ...
              {sellerData.specialties && sellerData.specialties.length > 0 && (
                <Card className="group overflow-hidden border-0 shadow-lg transition-all duration-300 hover:shadow-xl">
                  <CardHeader className="bg-gradient-to-r from-amber-50 to-orange-50 pb-4">
                    <div className="flex items-center gap-3">
                      <div className="rounded-xl bg-amber-100 p-3 transition-transform group-hover:scale-105">
