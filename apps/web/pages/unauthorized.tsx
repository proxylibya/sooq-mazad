...
export default function Unauthorized() {
  ...
  return (
    <>
      <Head>
        <title>غير مصرح - سوق المزاد</title>
      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-50 px-4 py-12">
        <div className="w-full max-w-4xl">
            ...
            <div className="relative inline-block">
              ...
              <div className="relative z-10 py-8">
                <div className="mx-auto flex h-32 w-32 items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-blue-400 md:h-48 md:w-48">
                  <LockClosedIcon className="h-16 w-16 text-white md:h-24 md:w-24" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12 text-center">
            <h2 className="mb-4 text-3xl font-bold text-gray-900 md:text-4xl">غير مصرح بالوصول</h2>
            <p className="mx-auto mb-6 max-w-2xl text-lg text-gray-600">
              عذراً، ليس لديك الصلاحيات الكافية للوصول إلى هذه الصفحة. يرجى تسجيل الدخول بحساب يمتلك
              الصلاحيات المطلوبة.
            </p>
            ...
            <div className="inline-flex items-center gap-2 rounded-full bg-blue-100 px-6 py-3">
              ...
              <p className="font-medium text-blue-700">هذه الصفحة تتطلب صلاحيات خاصة</p>
            </div>
          </div>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 text-right">
                    ...
                    <p className="text-sm text-gray-600">تسجيل الدخول بحساب آخر</p>
                  </div>
                </div>
              </button>
            </div>
