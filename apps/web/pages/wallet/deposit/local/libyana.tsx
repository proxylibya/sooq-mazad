/**
 * صفحة إيداع رصيد ليبيانا
 * Libyana Card Deposit Page
 */
...
export default function LibyanaDepositPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/wallet/deposit/libyana', {
        method: 'POST',
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gray-50">
      <Head>
        <title>إيداع رصيد ليبيانا | سوق مزاد</title>
      </Head>
      <OpensooqNavbar />
      ...
      <main className="mx-auto max-w-2xl px-4 py-8">
        ...
        <nav className="mb-6 text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">ليبيانا</span>
        </nav>
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900">إيداع رصيد ليبيانا</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border-2 border-gray-200 px-4 py-3 text-lg tracking-wider transition-colors focus:border-red-500 focus:outline-none"
                dir="ltr"
                maxLength={14}
              />
            ...
            <button
              ...
              className="w-full rounded-lg bg-gradient-to-r from-red-500 to-red-600 px-6 py-4 font-bold text-white transition-all hover:from-red-600 hover:to-red-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {isLoading ? (
