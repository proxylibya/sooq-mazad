...
-- Add promotion fields to transport_services table
ALTER TABLE "transport_services" ADD COLUMN IF NOT EXISTS "featured" BOOLEAN DEFAULT false;
ALTER TABLE "transport_services" ADD COLUMN IF NOT EXISTS "promotionPackage" TEXT DEFAULT 'free';
ALTER TABLE "transport_services" ADD COLUMN IF NOT EXISTS "promotionDays" INTEGER DEFAULT 0;
ALTER TABLE "transport_services" ADD COLUMN IF NOT EXISTS "promotionStartDate" TIMESTAMP(3);
ALTER TABLE "transport_services" ADD COLUMN IF NOT EXISTS "promotionEndDate" TIMESTAMP(3);
ALTER TABLE "transport_services" ADD COLUMN IF NOT EXISTS "promotionPriority" INTEGER DEFAULT 0;
...
CREATE INDEX IF NOT EXISTS "transport_services_featured_idx" ON "transport_services"("featured");
CREATE INDEX IF NOT EXISTS "transport_services_promotionPackage_idx" ON "transport_services"("promotionPackage");
